...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fafafa", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif", display: "flex", justifyContent: "center" }}>
      ...
      <aside style={{ width: 244, flexShrink: 0, position: "fixed", top: 0, left: 0, height: "100vh", borderRight: "1px solid #dbdbdb", background: "#fff", display: "flex", flexDirection: "column", padding: "20px 12px", zIndex: 100 }}>
        <div style={{ padding: "8px 16px 24px", fontSize: 22, fontStyle: "italic", fontWeight: 700, cursor: "pointer" }}>
          Instagram
        </div>
        <nav style={{ flex: 1, display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, padding: "12px 16px", borderRadius: 8, cursor: "pointer" }}>
      ...
      {/* Feed central */}
      <main style={{ marginLeft: 244, flex: 1, display: "flex", justifyContent: "center", padding: "24px" }}>
